...
export const masterSubjectGroupSlice = createSlice({
  name: "masterSubjectGroupSlice",
  initialState,
  reducers: {
    reset: () => initialState,
...
} = masterSubjectGroupSlice.actions;

export default masterSubjectGroupSlice.reducer;
